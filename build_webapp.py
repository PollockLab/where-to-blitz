...
<div id="panel" role="main">
  ...
  <details class="adv"><summary data-i18n="map_style">Map style</summary>
    ...
    <label class="toggle" style="margin:8px 0 2px"><input type="checkbox" id="tgCanadaOnly"> <span data-i18n="canada_only">🍁 Canada only</span></label>
...
function applyCanadaMask(){if(!caOnlyActive()||!US_CELLS)return;markers.forEach(m=>{if(US_CELLS.has(gekey(m.r[0],m.r[1])))m.mk.setStyle({opacity:0,fillOpacity:0});});}

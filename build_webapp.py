...
const I18N={
  en:{
    ...
    obj_q:["go where few people have looked","⚠ placeholder — the national rarity layer isn't available yet, so this goal has no effect","go where the climate is under-sampled","⚠ placeholder — no per-record dates nationally; currently mirrors 'Discover', so don't weight both","go where forest cover was recently lost (logging, fire, dieback)"],
    why_axis:["Few people have recorded here — what you find genuinely adds to the map.","Range-restricted species live here — your records support conservation.","This climate & habitat type is under-sampled — records here fill a real gap.","Overlooked lately — a fresh record here is overdue.","Forest cover changed here recently — recording now tracks what's shifting."],
  ...
  fr:{
    ...
    obj_q:["allez où peu de gens ont cherché","⚠ provisoire — la couche nationale de rareté n'est pas disponible, ce critère n'a aucun effet","allez où le climat est sous-échantillonné","⚠ provisoire — pas de dates par observation; reflète « Découvrir », ne pondérez pas les deux","allez où le couvert forestier a été récemment perdu (coupe, feu, dépérissement)"],
    why_axis:["Peu de gens ont observé ici — ce que vous trouvez enrichit vraiment la carte.","Des espèces à aire restreinte vivent ici — vos observations soutiennent la conservation.","Ce type de climat et d'habitat est sous-échantillonné — observer ici comble une vraie lacune.","Négligé récemment — une observation fraîche ici se fait attendre.","Le couvert forestier a changé ici récemment — observer maintenant suit ces changements."],

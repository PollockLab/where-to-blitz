...
PRESETS = [
    ...
    {"name": "Revisit the Past",    "w": [0.3, 0, 0, 1, 0],       "proj": "blitz-the-gap-revisiting-the-past",   "blurb": "Well-recorded long ago, quiet lately — revisit cells iNaturalist shows few recent records vs all-time."},
]
DEFAULT = PRESETS[0]["w"]
